...
git rebase master
```
- Resolver cualquier conflicto que pueda surgir durante el rebase.
```bash
# Editar los archivos en conflicto para resolverlos
git add <archivo_resuelto>
git rebase --continue
```
- Finalmente, hacer push de los cambios a la rama feature.
```bash
